...
extern "C" {
    ...
    #include "../jni/kyber-c/params.h"
    #include "../jni/kyber-c/kem.h"  // Include your kem.h header
...
extern "C" {
    // Simple test function - UPDATED PACKAGE NAME
    JNIEXPORT jstring JNICALL
    Java_com_reactnativekyber_KyberModule_sayHello(JNIEnv *env, jobject thiz) {
        LOGD("KyberModule sayHello called");
        return env->NewStringUTF("Hello from Kyber Module!");
    }

    // Generate Keypair - UPDATED PACKAGE NAME
    JNIEXPORT jobjectArray JNICALL
    Java_com_reactnativekyber_KyberModule_kyberGenerateKeypair(JNIEnv *env, jobject thiz) {
    ...
    // Encrypt function - UPDATED PACKAGE NAME
    JNIEXPORT jobjectArray JNICALL
    Java_com_reactnativekyber_KyberModule_kyberEncrypt(JNIEnv *env, jobject thiz, jbyteArray jpk) {
    ...
    // Decrypt function - UPDATED PACKAGE NAME
    JNIEXPORT jbyteArray JNICALL
    Java_com_reactnativekyber_KyberModule_kyberDecrypt(JNIEnv *env, jobject thiz, jbyteArray jct, jbyteArray jsk) {
