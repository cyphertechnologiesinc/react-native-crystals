...
exports.default = exports.Kyber = exports.Dilithium = void 0;
...
const DilithiumModule = _reactNative.NativeModules.Dilithium ? _reactNative.NativeModules.Dilithium : new Proxy({}, {
  get() {
    throw new Error(LINKING_ERROR);
  }
});
// Export both modules
const Kyber = exports.Kyber = KyberModule;
const Dilithium = exports.Dilithium = DilithiumModule;
