#ifndef DILITHIUM_NAMESPACE_H
#define DILITHIUM_NAMESPACE_H

// Define Dilithium-specific constants before including headers
...
#include "../dilithium-c/config.h"
#include "../dilithium-c/api.h"

#endif /* DILITHIUM_NAMESPACE_H */ 